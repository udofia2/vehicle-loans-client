...
>(({ className, ...props }, ref) => (
  <ToastPrimitives.Close
    ref={ref}
    className={cn(
      "absolute right-2 top-2 rounded-md p-1 text-foreground/50 opacity-0 transition-opacity hover:text-foreground focus:opacity-100 focus:outline-none focus:ring-2 group-hover:opacity-100 group-[.destructive]:text-red-600 group-[.destructive]:hover:text-red-700 group-[.destructive]:focus:ring-red-400 group-[.destructive]:focus:ring-offset-red-100 group-data-[variant=success]:text-green-600 group-data-[variant=success]:hover:text-green-700 group-data-[variant=success]:focus:ring-green-400 group-data-[variant=success]:focus:ring-offset-green-100",
      className
    )}
    toast-close=""
    {...props}
